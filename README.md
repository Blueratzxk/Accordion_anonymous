...
<img src="https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/icon.png" width="20%" />
...
![image](https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/UII.gif)  
...
```
$ git clone https://github.com/Blueratanonymous/Accordion_cpp
$ cd Accordion_cpp/
```
...
```
include_directories(
        "/home/anonymous/dependency/json/include/"
        "/usr/local/include/"
        "/home/anonymous/dependency/oneapi-tbb-2021.9.0/include"
)
...
![image](https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/UI1.png)

* Enter "run Q1S" in the left input box to run TPC-H Q1 (stand-alone version). There are 12 TPC-H queries in Accordion (Q1S ~ Q12S).

![image](https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/UI2.png)
...
![image](https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/UI31.png) 

* Click the `Complete` button to get the results of the query execution. 

![image](https://raw.githubusercontent.com/Blueratanonymous/Accordion_cpp/master/imgs/UI4.png)  
